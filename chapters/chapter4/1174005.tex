...
\begin{enumerate}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas4/materi/1.PNG}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas4/materi/2.PNG}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas4/materi/3.PNG}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas4/materi/4.PNG}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas4/materi/5.PNG}
		\caption{TF-IDF.}
	\end{figure}
\end{enumerate}
...
\begin{enumerate}
	\item Soal 1
	\hfill\break
	\lstinputlisting[firstline=8, lastline=10]{src/1174005/tugas4/tugas4.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas4/materi/hasil1.PNG}
		\caption{Hasil Soal 1.}
	\end{figure}

	\item Soal 2
	\hfill\break
	\lstinputlisting[firstline=12, lastline=14]{src/1174005/tugas4/tugas4.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005tugas4/materi/hasil21.PNG}
		\includegraphics[width=4cm]{figures/1174005/tugas4/materi/hasil22.PNG}
		\caption{Hasil Soal 2.}
	\end{figure}
	
	\item Soal 3
	\hfill\break
	\lstinputlisting[firstline=16, lastline=40]{src/1174005/tugas4/tugas4.py}
	Dengan menggunakan 1174005 mod 4 ialah 1, artinya disini saya memakai dataset LMFAO. Hasilnya adalah sebagai berikut :
	\begin{figure}[H]
	\centering
	...
	\item Soal 4
	\hfill\break
	\lstinputlisting[firstline=42, lastline=46]{src/1174005/tugas4/tugas4.py}
	...
	\item Soal 5
	\hfill\break
	\lstinputlisting[firstline=48, lastline=52]{src/1174005/tugas4/tugas4.py}
	...
	\item Soal 6
	\hfill\break
	\lstinputlisting[firstline=54, lastline=75]{src/1174005/tugas4/tugas4.py}
	Menjalankan program cross validation. Hasilnya adalah sebagai berikut :
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas4/materi/hasil6.PNG}
		\caption{Hasil Soal 6.}
	\end{figure}

	\item Soal 7
	\hfill\break
	\lstinputlisting[firstline=77, lastline=84]{src/1174005/tugas4/tugas4.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas4/materi/hasil7.PNG}
		\caption{Hasil Soal 7.}
	\end{figure}

	\item Soal 8
	\hfill\break
	\lstinputlisting[firstline=86, lastline=102]{src/1174005/tugas4/tugas4.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas4/materi/hasil8.PNG}
...
\begin{enumerate}
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174005/tugas4/error/1.PNG}
		\centering
		\caption{SyntaxError}
	\end{figure}
