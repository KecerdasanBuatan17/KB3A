...
\begin{enumerate}
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174027/6/2.png}
		\centering
		\caption{Contoh Pembobotan Neural Network}
	\end{figure}
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174027/6/1.png}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174027/6/3.png}
		\centering
	...
	\end{itemize}
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174027/6/4.png}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174027/6/5.png}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174027/6/6.png}
		\centering
		\caption{Sequential}
	\end{figure}
...
\begin{enumerate}
	...
	\lstinputlisting[firstline=9, lastline=28]{src/1174027/6/1174027.py}

	\item Penjelasan perbaris kode program dari display MFCC.
	\lstinputlisting[firstline=30, lastline=40]{src/1174027/6/1174027.py}

	\item Penjelasan perbaris code dari Extract Feature Song.
	\lstinputlisting[firstline=43, lastline=51]{src/1174027/6/1174027.py}

	\item Penjelasan perbaris code dari Generate Features and Labels.
	\lstinputlisting[firstline=55, lastline=72]{src/1174027/6/1174027.py}

	\item Penjelasan penggunaan fungsi Generate Features and Labels sangat lama ketika Meload Dataset Genre.
	\lstinputlisting[firstline=76, lastline=78]{src/1174027/6/1174027.py}

	\item Kenapa harus dilakukan pemisahan data training dan dataset sebesar 80\%
	\lstinputlisting[firstline=80, lastline=92]{src/1174027/6/1174027.py}

	\item Parameter dari fungsi Sequensial().
	\lstinputlisting[firstline=95, lastline=100]{src/1174027/6/1174027.py}

	\item Parameter dari fungsi Compile().
	\lstinputlisting[firstline=102, lastline=105]{src/1174027/6/1174027.py}

	\item Parameter dari fungsi Fit().
	\lstinputlisting[firstline=107, lastline=108]{src/1174027/6/1174027.py}

	\item Parameter dari fungsi Evaluate().
	\lstinputlisting[firstline=110, lastline=112]{src/1174027/6/1174027.py}

	\item Parameter dari fungsi Predict().
	\lstinputlisting[firstline=115, lastline=115]{src/1174027/6/1174027.py}
