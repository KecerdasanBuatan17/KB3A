...
\begin{enumerate}
	...
	\lstinputlisting[firstline=8, lastline=9]{src/1174005/tugas7/teori.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/teori3.PNG}
		\caption{Teori 3}
	\end{figure}
	...
	\lstinputlisting[firstline=14, lastline=21]{src/1174005/tugas7/teori.py}

	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/teori4.PNG}
		\caption{Teori 4}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/teori5.PNG}
		\caption{Teori 5}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/teori6.PNG}
		\caption{Teori 6}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/teori7.PNG}
		\caption{Teori 7}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/teori8.PNG}
		\caption{Teori 8}
	\end{figure}
	...
	\lstinputlisting[firstline=27, lastline=32]{src/1174005/tugas7/teori.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/teori9.PNG}
		\caption{Teori 9}
	\end{figure}
	...
	\lstinputlisting[firstline=35, lastline=36]{src/1174005/tugas7/teori.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/teori10.PNG}
		\caption{Teori 10}
	\end{figure}
...
\begin{enumerate}
	\item Soal 1
	\hfill\break
	\lstinputlisting[firstline=8, lastline=14]{src/1174005/tugas7/tugas7.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil1.PNG}
		\caption{Hasil Soal 1.}
	\end{figure}

	\item Soal 2
	\hfill\break
	\lstinputlisting[firstline=16, lastline=42]{src/1174005/tugas7/tugas7.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil2.PNG}
		\caption{Hasil Soal 2.}
	\end{figure}

	\item Soal 3
	\hfill\break
	\lstinputlisting[firstline=44, lastline=54]{src/1174005/tugas7/tugas7.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil3.PNG}
		\caption{Hasil Soal 3.}
	\end{figure}

	\item Soal 4
	\hfill\break
	\lstinputlisting[firstline=56, lastline=66]{src/1174005/tugas7/tugas7.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil4.PNG}
		\caption{Hasil Soal 4.}
	\end{figure}

	\item Soal 5
	\hfill\break
	\lstinputlisting[firstline=68, lastline=72]{src/1174005/tugas7/tugas7.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil5.PNG}
		\caption{Hasil Soal 5.}
	\end{figure}

	\item Soal 6
	\hfill\break
	\lstinputlisting[firstline=74, lastline=79]{src/1174005/tugas7/tugas7.py}
	Kode diatas berfungsi untuk melakukan convert class names ke one-hot encoding. Hasilnya adalah sebagai berikut :
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil6.PNG}
		\caption{Hasil Soal 6.}
	\end{figure}

	\item Soal 7
	\hfill\break
	\lstinputlisting[firstline=81, lastline=87]{src/1174005/tugas7/tugas7.py}
	Kode di atas befungsi untuk melakukan convert integers ke fungsi one hot encoding. Hasilnya adalah sebagai berikut :
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil7.PNG}
		\caption{Hasil Soal 7.}
	\end{figure}

	\item Soal 8
	\hfill\break
	\lstinputlisting[firstline=89, lastline=101]{src/1174005/tugas7/tugas7.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil8.PNG}
		\caption{Hasil Soal 8.}
	\end{figure}

	\item Soal 9
	\hfill\break
	\lstinputlisting[firstline=103, lastline=109]{src/1174005/tugas7/tugas7.py}
	Kode di atas befungsi untuk melakukan import sequential dari library keras. Hasilnya adalah sebagai berikut : 
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil9.PNG}
		\caption{Hasil Soal 9.}
	\end{figure}

	\item Soal 10
	\hfill\break
	\lstinputlisting[firstline=111, lastline=135]{src/1174005/tugas7/tugas7.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil10.PNG}
		\caption{Hasil Soal 10.}
	\end{figure}

	\item Soal 11
	\hfill\break
	\lstinputlisting[firstline=137, lastline=142]{src/1174005/tugas7/tugas7.py}
	Kode di atas befungsi untuk melakukan load callbacks pada library keras. Hasilnya adalah sebagai berikut : 
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil11.PNG}
		\caption{Hasil Soal 11.}
	\end{figure}

	\item Soal 12
	\hfill\break
	\lstinputlisting[firstline=143, lastline=155]{src/1174005/tugas7/tugas7.py}
	...
	\item Soal 13
	\hfill\break
	\lstinputlisting[firstline=157, lastline=212]{src/1174005/tugas7/tugas7.py}
	...
	\item Soal 14
	\hfill\break
	\lstinputlisting[firstline=215, lastline=237]{src/1174005/tugas7/tugas7.py}
	...
	\item Soal 15
	\hfill\break
	\lstinputlisting[firstline=238, lastline=244]{src/1174005/tugas7/tugas7.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil15.PNG}
		\caption{Hasil Soal 15.}
	\end{figure}

	\item Soal 16
	\hfill\break
	\lstinputlisting[firstline=246, lastline=248]{src/1174005/tugas7/tugas7.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil16.PNG}
		\caption{Hasil Soal 16.}
	\end{figure}

	\item Soal 17
	\hfill\break
	\lstinputlisting[firstline=250, lastline=252]{src/1174005/tugas7/tugas7.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil17.PNG}
		\caption{Hasil Soal 17.}
	\end{figure}

	\item Soal 18
	\hfill\break
	\lstinputlisting[firstline=255, lastline=262]{src/1174005/tugas7/tugas7.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174005/tugas7/materi/hasil18.PNG}
		\caption{Hasil Soal 18.}
	\end{figure}

	\item Soal 19
	\hfill\break
	\lstinputlisting[firstline=264, lastline=284]{src/1174005/tugas7/tugas7.py}
	...
	\item Soal 20
	\hfill\break
	\lstinputlisting[firstline=286, lastline=292]{src/1174005/tugas7/tugas7.py}
...
\begin{figure}[H]
\centering
	\includegraphics[width=4cm]{figures/1174005/tugas7/buktiplagiat/1.PNG}
	\includegraphics[width=4cm]{figures/1174005/tugas7/buktiplagiat/2.PNG}
