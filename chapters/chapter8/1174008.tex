...
Disini menggunakan Adam sebagai algoritma pengoptimalan dan binary_crossentropy sebagai kerugian loss. 
...
Ini adalah tahap akhir untuk melakukan testing dari model yang telah dibuat dan buat model dari yang sudah di create sebelumnya yaitu generator dan diskriminator.
		...
		\lstinputlisting[firstline=1, lastline=18]{src/1174008/8/praktik17.py}
