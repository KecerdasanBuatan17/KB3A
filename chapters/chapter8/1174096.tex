...
\begin{enumerate}
	...
	\hfill\break
    \lstinputlisting[firstline=29, lastline=59]{src/1174096/8/run.py}
	...
	\hfill\break
	\lstinputlisting[firstline=62, lastline=100]{src/1174096/8/run.py}
    ...
    \hfill\break
    \lstinputlisting[firstline=281, lastline=301]{src/1174096/8/run.py}
    ...
    \lstinputlisting[firstline=156, lastline=164]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=170, lastline=177]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=179, lastline=185]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=187, lastline=190]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=192, lastline=194]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=196, lastline=197]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=200, lastline=204]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=206, lastline=209]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=211, lastline=212]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=214, lastline=215]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=220, lastline=229]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=235, lastline=240]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=242, lastline=250]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=252, lastline=254]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=259, lastline=260]{src/1174096/8/run.py}
    \hfill\break
    ...
    \lstinputlisting[firstline=263, lastline=279]{src/1174096/8/run.py}
    \hfill\break
