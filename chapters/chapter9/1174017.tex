...
\begin{figure}[H]
	\includegraphics[width=4cm]{figures/1174017/9/3.png}
	\centering
...
\begin{figure}[H]
	\includegraphics[width=4cm]{figures/1174017/9/4.png}
	\centering
...
\begin{figure}[H]
	\includegraphics[width=4cm]{figures/1174017/9/5.png}
	\centering
...
\begin{figure}[H]
	\includegraphics[width=4cm]{figures/1174017/9/6.png}
	\centering
...
\begin{figure}[H]
	\includegraphics[width=4cm]{figures/1174017/9/7.png}
	\centering
...
\begin{figure}[H]
	\includegraphics[width=4cm]{figures/1174017/9/8.png}
	\centering
...
\item Nomor 1\\
\hfill\break
	\lstinputlisting[firstline=25, lastline=30]{src/1174017/9/1174017.py}
...
\item Nomor 2\\
\hfill\break
	\lstinputlisting[firstline=33, lastline=57]{src/1174017/9/1174017.py}
Maksud dari kode diatas yaitu untuk melakukan load data dan melakukan fungsi perhitungan usia

\item Nomor 3\\
\hfill\break
	\lstinputlisting[firstline=60, lastline=99]{src/1174017/9/1174017.py}
...
\item Nomor 4\\
\hfill\break
	\lstinputlisting[firstline=102, lastline=140]{src/1174017/9/1174017.py}
...
\item Nomor 5\\
\hfill\break
	\lstinputlisting[firstline=143, lastline=174]{src/1174017/9/1174017.py}
Maksud diskriminator pada kode diatas yaitu untuk membedakan antara gambar yang asli dan gambar yang palsu

\item Nomor 6\\
\hfill\break
	\lstinputlisting[firstline=177, lastline=309]{src/1174017/9/1174017.py}
...
\item Nomor 7\\
\hfill\break
	\lstinputlisting[firstline=312, lastline=355]{src/1174017/9/1174017.py}
