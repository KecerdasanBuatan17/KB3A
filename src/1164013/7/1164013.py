...
@author: Ikrima Ningrum
"""

# In[1]:import lib
# menimport library CSV untuk mengolah data ber ekstensi csv
import csv 
#lalu import library Image dari PIL atau Python Imaging Library untuk mengolah data berupa gambar
from PIL import Image as pil_image 
# lalu import library keras dengan menggunakan method preprocessing untuk membuat neural network
...
with open('HASYv2/hasy-data-labels.csv') as csvfile:
    ...
    for row in csvreader:
        ...
        if i > 0:
            ...
            img /= 255.0
            # Penambahan nilai baru pada imgs pada row ke 1 2, dilanjutkan dengan variabel img
...
random.shuffle(imgs)
# Menginisiasi variabel split_idx dengan nilai integer 80% dikali dari pengembalian jumlah dari variabel imgs
