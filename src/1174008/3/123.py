# -*- coding: utf-8 -*-
"""
Created on Tue Mar 17 10:34:35 2020
...
laptop = {"Nama Laptop" : ['Asus','ROG','Lenovo','Samsung']} #membuat varibel yang bernama laptop, dan mengisi dataframe nama2 laptop
x = Arjun.DataFrame(laptop) #variabel x membuat DataFrame dari library pandas dan akan memanggil variabel laptop. 
...
Arjun.plot([1,1,7,4,0,2,1]) #memberikan nilai plot atau grafik pada arjun
