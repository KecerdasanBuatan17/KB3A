# -*- coding: utf-8 -*-
"""
Created on Tue Mar 24 14:59:46 2020
...
pd = pd.read_csv("csv_fahmi.csv") #membaca file csv 
...
#%% Soal 3
import pandas as fahmi #untuk import library pandas berguna untuk mengelola dataframe
fahmi = fahmi.read_csv("Youtube03-LMFAO.csv") #membaca file dengan format csv
...
dvec = vectorizer.fit_transform(fahmi['CONTENT']) #untuk melakukan pemecahan data pada dataframe yang terdapat pada kolom konten
...
rf_params = fahmi.empty((len(max_features_opts)*len(n_estimators_opts),4), float) #rf_params sebagai variabel untuk menjumlahkan yang sudah di tentukan sebelumnya
i = 0
