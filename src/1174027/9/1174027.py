# -*- coding: utf-8 -*-
"""
Created on Tue Jun 16 13:25:57 2020
...
import tarfile
tf = tarfile.open("/content/drive/My Drive/Colab Notebooks/GIT CH 9/data/wiki_crop.tar")
tf.extractall(path="/content/drive/My Drive/Colab Notebooks/GIT CH 9/data")
#%%
import os
import os
import time
