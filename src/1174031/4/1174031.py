# -*- coding: utf-8 -*-
"""
Created on Tue Mar 24 11:40:18 2020
...
tomy = pd.read_csv("E:/Kuliah/Semester 6/Kecerdasan Buatan/Tugas/bahan 4/paslonpilkada20151016_csv.csv") 
...
#%% memasukkan data dari file paslonpilkada20151016_csvcsv tersebut ke dalam variable data
data=pd.read_csv("E:/Kuliah/Semester 6/Kecerdasan Buatan/Tugas/bahan 4/paslonpilkada20151016_csv.csv")
spam=data.query('pekerjaan == 1')
nospam=data.query('pekerjaan == 0')
#%% melakukan fungsi bag of word dengan cara menghitung semua kata
from sklearn.feature_extraction.text import CountVectorizer
vectorizer = CountVectorizer()
#%% melakukan bag of word pada dataframe pada colom nama
data_vektorisasi = vectorizer.fit_transform(data['nama'])
...
dk_train_att=vectorizer.fit_transform(dk_train['nama'])
print(dk_train_att)
#%% melakukan testing pada data testing dan di vektorisasi
dk_test_att=vectorizer.transform(dk_test['nama'])
print(dk_test_att)
#%%: Dimana akan mengambil label spam dan bukan spam
dk_train_label=dk_train['pekerjaan']
print(dk_train_label)
dk_test_label=dk_test['pekerjaan']
print(dk_test_label)
