# -*- coding: utf-8 -*-
"""
Created on Tue Mar 24 11:44:54 2020
...
import pandas as coco
#membuat variable bernama nico dan mengisinya dengan data dari dataset dummy yang telah dibuat
nico = coco.read_csv("F:/Nico/Kampus/Artificial Inteligent/chapter4/KB3A/src/1174096/4/1174096.csv") 
#untuk melihat 5 baris pertama dari data nico
atas = nico.head() 
...
datatraining = nico[:450] 
#memasukkan 50 data terakhir kedalam variable datatesting
datatesting = nico[450:]
# In[soal 3]:
print(117496%4) #menghitung NPM Mod 4 untuk menentukan data yang akan digunakan
#mengimport library pandas dan menamainya coco
import pandas as coco
data=coco.read_csv("F:/Nico/Kampus/Artificial Inteligent/chapter4/KB3A/src/1174096/4/Youtube02-KatyPerry.csv")
