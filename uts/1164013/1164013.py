...
display_mfcc('singers/Lady Gaga/Lady Gaga - Paparazzi (Official Music Video).wav')
...
extract_features_song('Lady Gaga/Lady Gaga - Paparazzi (Official Music Video).wav')
...
def generate_features_and_labels():
    ...
    singers = ['Shallow', 'Poker Face', 'Bad Romance', 'Always Remember Us This Way', 'Paparazzi', 'I will Never Love Again', 'Alejandro', 'Million Reasons', 'Just Dance', 'Telephone']
