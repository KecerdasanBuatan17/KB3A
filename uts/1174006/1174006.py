...
display_mfcc('singers/beabadoobee/beabadoobee__angel.mp3')

display_mfcc('singers/girl_in_red/girl_in_red__girls.mp3')
...
extract_features_song('singers/girl_in_red/girl_in_red__girls.mp3')

extract_features_song('singers/beabadoobee/beabadoobee__angel.mp3')

def generate_features_and_labels():
    all_features = []
    all_labels = []

    singers = ['beabadoobee', 'bebe_rexha', 'cavetown', 'clairo', 'dodie', 'fazerdaze', 'girl_in_red', 'melanie_martinez', 'mxmtoon', 'spookyghostboy']
...
predict('singers/melanie_martinez/melanie_martinez__dollhouse.mp3')

predict('singers/beabadoobee/beabadoobee__angel.mp3')
