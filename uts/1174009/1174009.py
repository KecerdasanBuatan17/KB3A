...
display_mfcc('AGNEZ_MO/Coke_bottle.wav')
...
extract_features_song('AGNEZ_MO/Coke_bottle.wav')
extract_features_song('Evanescence/bring me to life.wav')
...
def generate_features_and_labels():
    ...
    singers = ['AGNEZ_MO', 'Anang_Hermansyah', 'Evanescence', 'Harry_Styles', 'Inul_Daratista', 'Lady_gaga', 'One_Direction', 'Saykoji', 'Syahrini', 'Usher']
