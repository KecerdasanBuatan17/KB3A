...
display_mfcc('Siti_Badriah/Coke_bottle.wav')
display_mfcc('Evanescence/bring me to life.wav')
...
extract_features_song('Siti_Badriah/Bara_Bere.wav')
extract_features_song('Zaskia Gotik/satu jam saja.wav')
...
def generate_features_and_labels():
    ...
    singers = ['Siti_badriah', 'Sazkia_gotik', 'ayu_Tingting', 'Heri_zusan', 'Inul_Daratista', 'Iis_dahlia', 'Ivan_Gunawan', 'Nasar', 'Syahrini', 'Usher']
...
predict('AGNEZ_MO/Coke_bottle.wav')
predict('Evanescence/bring me to life.wav')
