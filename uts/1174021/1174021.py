# -*- coding: utf-8 -*-
"""
Created on Sun Apr  5 21:26:52 2020
...
display_mfcc('dataset/noah/1.wav')

display_mfcc('dataset/weird_genius/1.wav')
...
extract_features_song('dataset/weird_genius/1.wav')
...
def generate_features_and_labels():
    ...
    singers = ['noah', 'weird_genius', 'tereza', 'armada', 'iwan_fals', 'kangen_band', 'radja', 'slank', 'via_vallen', 'willy']
...
#%%
#predict('dataset/weird_genius/1.wav')
predict('dataset/noah/2.wav')
