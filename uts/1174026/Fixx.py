# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 20:28:17 2020
...
display_mfcc('D:/git/4 editt/baru/singers/atemnang/atemnang.1.mp3')

display_mfcc('D:/git/4 editt/baru/singers/CHARLES_RANI/CHARLES_RANI.4.mp3')
# In[]
...
extract_features_song('D:/git/4 editt/baru/singers/CHARLES_RANI/CHARLES_RANI.4.mp3')

extract_features_song('D:/git/4 editt/baru/singers/atemnang/atemnang.1.mp3')
# In[]
def generate_features_and_labels():
    all_features = []
    all_labels = []

    singers = ['atemnang', 'CHARLES_RANI', 'Judika', 'Kangen_band', 'lamtio', 'putri_silitongn', 'sheila_on_7', 'Siti_Badriah', 'TrioMarsada', 'Wali']
...
predict('D:/git/4 editt/baru/singers/atemnang/atemnang.1.mp3')
