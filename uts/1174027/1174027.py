...
display_mfcc('Hatsune Miku/Hatsune Miku - Mikku Miku ni Shite Ageru.wav')
display_mfcc('Hatsune Miku/Hatsune Miku - triple baka.wav')
...
extract_features_song('Hatsune Miku/Hatsune Miku - triple baka.wav')
extract_features_song('Hatsune Miku/Hatsune Miku - Mikku Miku ni Shite Ageru.wav')
...
def generate_features_and_labels():
    ...
    singers = ['Armada', 'Dbagindas', 'Doel Sumbang', 'Hatsune Miku', 'Love Life', 'Selena Gomez', 'Supercell', 'Taylor Swift', 'The Chainsmokers', 'Zigaz']
...
predict('Hatsune Miku/Hatsune Miku - triple baka.wav')
predict('Hatsune Miku/Hatsune Miku - Mikku Miku ni Shite Ageru.wav')
