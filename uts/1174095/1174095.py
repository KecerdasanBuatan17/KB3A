# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 21:21:49 2020
...
display_mfcc('dataset/SOD/1.wav')

display_mfcc('dataset/Burgerkill/1.wav')
#%%
...
extract_features_song('dataset/Burgerkill/1.wav')

extract_features_song('dataset/SOD/1.wav')
#%%
def generate_features_and_labels():
    all_features = []
    all_labels = []

    singers = ['Burgerkill', 'SOD', 'shaggydog', 'dhyo_haw', 'Nella', 'NOAH', 'scorpions', 'sheilaon7', 'UNGU', 'virzha']
    for singer in singers:
        sound_files = glob.glob('dataset/'+singer+'/*.wav')
...
#%%
predict('dataset/Burgerkill/10.wav')
predict('dataset/shaggydog/10.wav')
