# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 23:28:17 2020
...
display_mfcc('D:/utsnico/singers/betharia_sonatha/03 tak mungkin lagi.mp3')

display_mfcc('D:/utsnico/singers/broery_marantika/07 jangan ganggu aku.mp3')
...
extract_features_song('D:/utsnico/singers/christine_panjaitan/01 sudah kubilang.mp3')

extract_features_song('D:/utsnico/singers/dian_piesesha/09 satukanlah hati kami.mp3')

def generate_features_and_labels():
    all_features = []
    all_labels = []

    singers = ['betharia_sonatha', 'broery_marantika', 'christine_panjaitan', 'dian_piesesha', 'panbers','ratih_purwasih','rinto_harahap','nia_daniaty','tommy_j_pisa','trio_ambisi']
...
predict('D:/utsnico/singers/nia_daniaty/01 gelas-gelas kaca.mp3')

predict('D:/utsnico/singers/panbers/Panbers - Gereja Tua.mp3')
